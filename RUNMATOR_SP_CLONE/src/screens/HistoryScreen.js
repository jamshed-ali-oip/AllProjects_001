        ...
        <SafeAreaView style={{ flex: 1 }}>
          ...
          <FlatList
            ...
            renderItem={({ item, index }) => (
              ...
              //     <View>
              //       <Text>{item.service_proivder_client[0].name}</Text>
              //     </View>
              // </TouchableOpacity>
              <View
                style={{
              ...
              >
                <View
                  ...
                  <Text style={{ color: colors.themeBlue, fontWeight: 'bold', fontSize: 18, textTransform: 'capitalize' }}>{item.service_proivder_client[0]?.name}</Text>
                </View>
                <View
                  style={{
                    flexDirection: 'row',
                ...
                >
                  <View style={{ width: '40%', justifyContent: 'center', alignItems: 'center' }}>
                    <Image
                      source={(item.service_proivder_client[0]?.profile_image) ? { uri: imgUrl2 + "/" + item.service_proivder_client[0]?.profile_image } : require('../assets/user.png')}
                  ...
                  <View style={{ width: '60%', justifyContent: 'center' }}>
                    <View>
                      ...
                      <Text style={{ color: 'black', fontSize: 12 }}>Phone No: {item.service_proivder_client[0]?.phone}</Text>
                      {
...
const mapStateToProps = ({ user, allBooking }) => {
  return {
    user,
    allBooking,
  };
