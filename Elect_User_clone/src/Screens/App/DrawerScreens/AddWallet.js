...
import { AddNewCard } from '../../../redux/actions/ride.action';
    ...
    return (
        <SafeAreaView>
            ...
            >
                ...
                >{Country == "UKRAINE" ? "Додати картку" : "Add Card"}</Text>
                ...
                >
                    ...
                    >
                        ...
                        <SecondayButton
                            ...
                            title={loading == true ? <ActivityIndicator size={"small"} color={Colors.white} /> : Country == "UKRAINE" ? "Зберегти картку" : "Save Card"}
                        />
                    </View>
