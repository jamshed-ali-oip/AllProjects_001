...
const HomeLocation = ({ navigation }) => {
    ...
    useEffect(() => {
        if (me?.home_lng) {
            SelecFinaltLocation({
                formattedAddress: me?.home_address,
    ...
    const updateMe = () => {
        ...
        if (FinalLocation !== undefined) {
            const data = {
                home_lat: FinalLocation?.latitude?.toString(),
                home_lng: FinalLocation?.longitude?.toString(),
                home_address: FinalLocation?.formattedAddress
            }
            console.log(data, "==================")
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    {Country == "UKRAINE" ? "Розташування будинку" : "Home Location"}
                </Text>
            ...
            <GoogleInput
                ...
                title={Country == "UKRAINE" ? "Виберіть «Домашнє розташування»." : "Select Home Location"}
                setAddressText={() => { "" }}
