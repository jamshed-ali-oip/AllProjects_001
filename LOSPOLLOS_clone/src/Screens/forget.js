...
const Forget = ({navigation}) => {
  ...
  return (
    <View>
      ...
      <Header title={show == false ? 'Mot de passe oublié' : 'Retour'} />
      <View style={{alignItems: 'center'}}>
        ...
        <Image
          ...
          source={require('../images/Ottp.png')}
        />
        <Text
          style={{
            width: width * 0.59,
          ...
          Un code de réinitialisation de mot de passe a été envoyé à
        </Text>
        <Text
          style={{
            width: width * 0.8,
        ...
        <OTPInputView
          style={{width: '65%', height: height * 0.1, alignSelf: 'center'}}
          pinCount={4}
          ...
          <View style={{position: 'absolute'}}>
            ...
            <View
              ...
              <TouchableOpacity
                ...
                onPress={() => {navigation.navigate("confirmpas")}}
                >
                <Image
                  style={{
                    width: width * 0.13,
