              ...
              <View style={{position: 'absolute'}}>
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      navigation.navigate('Resenscode');
                    }}>
                    <Image
                      style={{
                        width: width * 0.12,
                    ...
                    />
                    <View
                      style={{alignSelf: 'center', marginTop: height * 0.09}}>
                      <Text
                        style={{
                          color: '#C12F2F',
                          textAlign: 'center',
                  ...
                  <TouchableOpacity
                    ...
                    <View
                      ...
                      <Text
                        ...
                        Recevez un e-mail contenant un code
                      </Text>
                    </View>
                  </TouchableOpacity>
                </View>
