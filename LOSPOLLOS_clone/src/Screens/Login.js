          ...
          <View style={styles.ctn2}>
            ...
            <View style={styles.inputbox}>
              ...
              <Image
                style={styles.eye}
                source={
                eye=== true?require('../images/Eyeoff.png'):require('../images/openeye.png')
            ...
            <View style={{flexDirection:"row",justifyContent:"space-between",marginTop:height*0.01}}>
              <TouchableOpacity style={{flexDirection:"row",alignSelf:"flex-start"}}>
                ...
                />
                <Text style={{color:"#000"}}>Se Souvenir de moi</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={()=>{navigation.navigate("forget")}} style={{marginLeft:width*0.09}}>
                <Text style={{fontWeight: '700',color:"#000",textDecorationStyle:"solid",textDecorationLine:"underline"}}>Mot de passe oublié ?</Text>
              </TouchableOpacity>
            </View>
            <TouchableOpacity
              onPress={() => {
